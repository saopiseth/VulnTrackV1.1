...
<div class="row g-3">
    <div class="col-md-6">
        ...
        <input type="text" name="ip_address" id="{{ $prefix }}-ip" class="form-control"
               placeholder="e.g. 192.168.1.10" style="border-radius:10px;border-color:#e2e8f0;font-size:.875rem">
    </div>
    <div class="col-md-6">
        <label class="form-label fw-semibold" style="font-size:.82rem">Hostname</label>
        <input type="text" name="hostname" id="{{ $prefix }}-hostname" class="form-control"
               placeholder="e.g. web-server-01" style="border-radius:10px;border-color:#e2e8f0;font-size:.875rem">
    </div>
    <div class="col-md-6">
        <label class="form-label fw-semibold" style="font-size:.82rem">System Name</label>
        <input type="text" name="system_name" id="{{ $prefix }}-system" class="form-control"
               placeholder="e.g. Core Banking System" style="border-radius:10px;border-color:#e2e8f0;font-size:.875rem">
    </div>
    <div class="col-md-6">
        <label class="form-label fw-semibold" style="font-size:.82rem">System Owner</label>
        <input type="text" name="system_owner" id="{{ $prefix }}-owner" class="form-control"
               placeholder="e.g. IT Department" style="border-radius:10px;border-color:#e2e8f0;font-size:.875rem">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        ...
        <select name="identified_scope" id="{{ $prefix }}-scope" class="form-select"
                style="border-radius:10px;border-color:#e2e8f0;font-size:.875rem">
            <option value="">— Select —</option>
    ...
    <div class="col-md-6">
        ...
        <select name="environment" id="{{ $prefix }}-env" class="form-select"
                style="border-radius:10px;border-color:#e2e8f0;font-size:.875rem">
            <option value="">— Select —</option>
