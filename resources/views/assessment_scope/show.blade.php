...
<div class="row g-3 mb-4">
    ...
    @foreach(['PCI'=>'#dc2626','DMZ'=>'#d97706','Internal'=>'#2563eb','External'=>'#7c3aed'] as $s => $c)
        ...
        <div class="table-responsive">
            <table class="table mb-0 align-middle" style="font-size:.85rem">
                ...
                @forelse($items as $item)
                    @php $scopeColors = ['PCI'=>['#fef2f2','#991b1b'],'DMZ'=>['#fffbeb','#92400e'],'Internal'=>['#eff6ff','#1e40af'],'External'=>['#f5f3ff','#6d28d9']]; $sc = $scopeColors[$item->identified_scope] ?? null; @endphp
