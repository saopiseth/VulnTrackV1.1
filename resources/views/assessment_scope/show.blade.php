...
<div class="row g-3 mb-4">
    ...
    @foreach(['PCI'=>'#dc2626','Swift'=>'#0891b2','Non-Bank'=>'#059669','Public'=>'#b45309','Critical'=>'#be123c','Less Critical'=>'#6d28d9'] as $s => $c)
        ...
        <div class="table-responsive">
            <table class="table mb-0 align-middle" style="font-size:.85rem">
                ...
                @forelse($items as $item)
                    @php $scopeColors = ['PCI'=>['#fef2f2','#991b1b'],'Swift'=>['#ecfeff','#0e7490'],'Non-Bank'=>['#f0fdf4','#166534'],'Public'=>['#fef3c7','#b45309'],'Critical'=>['#fff1f2','#be123c'],'Less Critical'=>['#faf5ff','#6d28d9']]; $sc = $scopeColors[$item->identified_scope] ?? null; @endphp
...
document.getElementById('downloadTemplateBtn').addEventListener('click', function () {
    ...
    const wsRef = XLSX.utils.aoa_to_sheet([
        ...
        ['identified_scope','PCI | Swift | Non-Bank | Public | Critical | Less Critical'],
