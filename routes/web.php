...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/vuln-assessments/{vulnAssessment}/initial-file/download',       [VulnAssessmentController::class, 'downloadInitialFile'])->name('vuln-assessments.download-initial-file');
    Route::get('/vuln-assessments/{vulnAssessment}/verification-file/download',  [VulnAssessmentController::class, 'downloadVerificationFile'])->name('vuln-assessments.download-verification-file');
    ...
    Route::patch('/account/criticality-settings', [AccountController::class, 'updateCriticalitySettings'])->name('account.criticality-settings.update');
